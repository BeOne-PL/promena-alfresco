...
package pl.beone.promena.alfresco.module.transformerrendition.mock.transformer
...
import pl.beone.promena.alfresco.module.transformerrendition.mock.MockConstants.BOOLEAN
import pl.beone.promena.alfresco.module.transformerrendition.mock.MockConstants.INT
import pl.beone.promena.alfresco.module.transformerrendition.mock.MockConstants.NULL
import pl.beone.promena.alfresco.module.transformerrendition.mock.MockConstants.STRING

class MockTransformerDebug : TransformerDebug() {
    ...
    override fun unavailableTransformer(
    ...
    override fun blacklistTransform(
        transformer: ContentTransformer?,
        sourceMimetype: String?,
        targetMimetype: String?,
        options: TransformationOptions?
